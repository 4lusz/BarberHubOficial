...
class BarbershopUpdate(BaseModel):
    ...
    banner_position: Optional[str] = None  # top, center, bottom (deprecated)
    banner_zoom: Optional[int] = None  # 100-200%
    banner_offset_y: Optional[int] = None  # 0-100%
...
class Barbershop(BaseModel):
    ...
    logo_url: Optional[str] = None
    banner_url: Optional[str] = None
    banner_position: str = "center"  # top, center, bottom (deprecated)
    banner_zoom: int = 100  # 100-200%
    banner_offset_y: int = 50  # 0-100%
    about_text: Optional[str] = None
    instagram_url: Optional[str] = None
    facebook_url: Optional[str] = None
    whatsapp_number: Optional[str] = None
...
class SuperAdminCreateBarbershop(BaseModel):
    name: str
    owner_name: str
    email: str
    password: str
    phone: Optional[str] = None
    plan: str = "premium"  # comum ou premium

@api_router.post("/super-admin/barbershops")
async def super_admin_create_barbershop(
    data: SuperAdminCreateBarbershop,
    admin: dict = Depends(verify_super_admin)
):
...
if cors_origins_env and cors_origins_env != '*':
    ...
    allowed_origins = [
        ...
        "https://barber-schedule-49.preview.emergentagent.com",
        "http://localhost:3000",
    ]
